...
BOT_TOKENS_RAW = os.environ.get("TOKENS", "7790991731:AAF4NHGm0BJCf08JTdBaUWKzwfs82_Y9Ecw,7770743573:AAGovhDxwzYyn9vZhC-RBCtqe6OoT2a6ZHA")
...
bot_tokens_list = parse_keys(BOT_TOKENS_RAW)
TOKENS = bot_tokens_list
...
for i, token in enumerate(TOKENS):
    app = Client(f"media_transcriber_{i}", api_id=API_ID, api_hash=API_HASH, bot_token=token)
    apps.append(app)
...
def run_bots():
    ...
    tasks = []
    for app in apps:
        tasks.append(loop.create_task(app.start()))
