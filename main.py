...
# Shaqo la mid ah tii asalka ahayd (wax isbeddel ah laguma samayn)
...
async def handle_cleanup_callback(client, call: CallbackQuery):
    ...
    uid = call.from_user.id # Waxaan ku darnaa si aan u helno mode-ka
    mode = user_mode.get(uid, "📄 Text File") # Hel mode-ka user-ka
    ...
    try:
        ...
        # Qaybta la hagaajiyay si loo raaco shuruudahaaga
